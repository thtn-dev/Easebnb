...
namespace Easebnb.Organization.Infrastructure.Database.Migrations
{
    ...
    [Migration("20260823153446_Add_Organizations_And_Members")]
    partial class Add_Organizations_And_Members
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Easebnb.Organization.Core.Entities.Organization", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Easebnb.Organization.Core.Entities.OrganizationMember", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Easebnb.Organization.Core.Entities.RegisteredUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_registered_users");

                    b.ToTable("registered_users", "organization");
                });
            ...
            modelBuilder.Entity("MassTransit.EntityFrameworkCoreIntegration.InboxState", b =>
                {
                    ...
                    b.ToTable("inbox_state", "organization");
                });
            ...
            modelBuilder.Entity("MassTransit.EntityFrameworkCoreIntegration.OutboxMessage", b =>
                {
                    ...
                    b.ToTable("outbox_message", "organization");
                });
            ...
            modelBuilder.Entity("MassTransit.EntityFrameworkCoreIntegration.OutboxState", b =>
                {
                    ...
                    b.ToTable("outbox_state", "organization");
                });

            modelBuilder.Entity("Easebnb.Organization.Core.Entities.OrganizationMember", b =>
                {
                    b.HasOne("Easebnb.Organization.Core.Entities.Organization", null)
                        .WithMany()
